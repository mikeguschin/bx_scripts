...
$MESS ['SOA_TEMPL_MODULE_HTML'] = "Информация";
$MESS ['SOA_TEMPL_MODULE_HTML_SHOW'] = "Развернуть";
...
$MESS ['LM_AUTO_DAYS'] = "д";
$MESS['ARUS_PERSON_TYPE_TITLE'] = 'Оформить заказ как';
$MESS['ARUS_PERSON_TYPE_1'] = 'Физическое лицо';
$MESS['ARUS_PERSON_TYPE_2'] = 'Юридическое лицо';
$MESS['ARUS_CLIENT_INFORMATION'] = 'Информация о клиенте:';
$MESS['ARUS_AVAILABLE_CLIENTS'] = 'Доступные клиенты:';
$MESS['ARUS_DELIVERY_TYPE'] = 'Способ получения заказа';
$MESS['ARUS_AVAILABLE_CLIENTS'] = 'Доступные клиенты:';
$MESS['ARUS_CLIENT_NAME'] = 'Контактное лицо:';
$MESS['ARUS_CLIENT_PHONE'] = 'Телефон:';
$MESS['ARUS_CLIENT_CODE'] = 'код:';
$MESS['ARUS_CLIENT_ADDRESS'] = 'Адрес:';
$MESS['ARUS_FULL_ORDER_FIELD_NAME'] = 'Отгружать заказ только целиком';
$MESS['ARUS_ORDER_DESCRIPTION_FIELD_NAME'] = 'Комментарии к заказу:';
$MESS['ARUS_AVAILABLE_PAYERS'] = 'Доступные плательщики:';
$MESS['ARUS_PAYERS_INFO'] = 'Информация о плательщике:';
$MESS['ARUS_PAYERS_INN'] = 'ИНН:';
$MESS['ARUS_PAYERS_KPP'] = 'КПП:';
$MESS['ARUS_CORP_ORDER_TITLE'] = 'Оформление заказа для корпоративных клиентов';
$MESS['ARUS_TEMPL_SUM_SUMMARY'] = 'Сумма';
$MESS['ARUS_RECALC_BASKET_MESSAGE'] = '<h2>Уважаемый покупатель!</h2> У некоторых товаров после помещения в корзину изменились цена или доступное количество. Для того, чтобы получить актуальную информацию, нажмите, пожалуйста, на на кнопку "<b>ПЕРЕСЧИТАТЬ ЗАКАЗ</b>" Спасибо!<br/><br/>';
$MESS['ARUS_RECALC_BASKET_BUTTON'] = 'Пересчитать заказ';
$MESS['ARUS_DELIVERY_STORE_NOT_SELECTED'] = 'Выбран способ получения заказа «Самовывоз», но не указан пункт выдачи';
$MESS['ARUS_CORP_PAYERS_TITLE'] = 'Плательщик:';
$MESS['ARUS_WANTED_DELIVERY_DATE_TITLE'] = "Желаемая дата доставки";
$MESS['ARUS_CONTACT_PERSON_INCORRECT'] = 'Укажите контактное лицо для связи';
$MESS['ARUS_PHONE_NUMBER_INCORRECT'] = 'Некорректный номер телефона';
$MESS['ARUS_WANTED_DELIVERY_DATE_TITLE_INCORRECT'] = "Не указана желаемая дата доставки";
$MESS["ARUS_TEMPL_DELIVERY_TIME"] = "Срок<br />доставки";
$MESS['ARUS_FULL_ORDER_FIELD_NAME_ERROR'] = 'Не заполнено поле «Отгружать заказ только целиком»';
$MESS['ARUS_CORP_FULL_ORDER_HELP_TEXT_POPUP'] = 'Если выбрано ДА, мы доставим вам товар только после полного обеспечения на складе отгрузки. В этом случае желаемая дата доставки рассчитывается исходя из максимального срока обеспеченности заказа на складе отгрузки, графика работы клиента, графика доставки в сектор.';